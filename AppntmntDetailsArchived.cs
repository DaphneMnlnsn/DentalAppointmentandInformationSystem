...
{
    public partial class AppntmntDetailsArchived : Form
    {
        Variables v = new Variables();
        SqlConnection constring;

        public AppntmntDetailsArchived()
        {
            InitializeComponent();
            constring = v.getConnection;
        }

        private void AppntmntDetailsArchived_FormClosing(object sender, FormClosingEventArgs e)
        {
            System.Windows.Forms.Application.Exit();
        }

        private void AppntmntDetailsArchived_Load(object sender, EventArgs e)
        {
            this.CenterToScreen();
        ...
        private void displayAppointments()
        {
            ...
            {
                AppointmentArchived appntmnt = new AppointmentArchived();
