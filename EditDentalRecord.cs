...
namespace DentalAppointmentandInformationSystem
{
    public partial class EditDentalRecord : Form
    {
        ...
        private void saveDentalRcrdBtn_Click(object sender, EventArgs e)
        {
            ...
            string editQuadrant1 = "UPDATE Teeth SET tooth_18 = '" + tooth18 +
                        ...
                        "' WHERE patient_id = " + int.Parse(v.getsetpatientSelected) + ";";
            ...
            string editQuadrant2 = "UPDATE Teeth SET tooth_21 = '" + tooth21 +
            ...
            string editQuadrant3 = "UPDATE Teeth SET tooth_31 = '" + tooth31 +
            ...
            string editQuadrant4 = "UPDATE Teeth SET tooth_48 = '" + tooth48 +
